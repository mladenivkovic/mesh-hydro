...
\begin{figure}[htbp]
	...
	\includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock.png}%
...
\begin{figure}[htbp]
	...
	\includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock-reverse.png}%
...
\begin{figure}[htbp]
	...
	\includegraphics[width=.9\textwidth]{../GODUNOV-riemann-left-vacuum.png}
...
\begin{figure}[htbp]
	...
	\caption{Godunov's method for left vacuum state. Expected result.}
	\includegraphics[width=.9\textwidth]{../GODUNOV-riemann-right-vacuum.png}
	\caption{Godunov's method for left vacuum state. Obtained result.}
\end{figure}
...
\begin{figure}[htbp]
	...
	\includegraphics[width=.9\textwidth]{../GODUNOV-riemann-vacuum-generating.png}%
