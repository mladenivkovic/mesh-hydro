...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (right facing) sod shock, MC flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-MC-riemann-sod-shock-2D.png}%
        \caption{WAF method for (right facing) sod shock, MC flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (left facing) sod shock, MC flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-MC-riemann-sod-shock-reverse-2D.png}%
        \caption{WAF method for (left facing) sod shock, MC flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (right facing) sod shock, MINMOD flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-MINMOD-riemann-sod-shock-2D.png}%
        \caption{WAF method for (right facing) sod shock, MINMOD flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (left facing) sod shock, MINMOD flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-MINMOD-riemann-sod-shock-reverse-2D.png}%
        \caption{WAF method for (left facing) sod shock, MINMOD flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (right facing) sod shock, van Leer flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-VANLEER-riemann-sod-shock-2D.png}%
        \caption{WAF method for (right facing) sod shock, van Leer flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (left facing) sod shock, van Leer flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-VANLEER-riemann-sod-shock-reverse-2D.png}%
        \caption{WAF method for (left facing) sod shock, van Leer flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (right facing) sod shock, SUPERBEE flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-SUPERBEE-riemann-sod-shock-2D.png}%
        \caption{WAF method for (right facing) sod shock, SUPERBEE flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{WAF method for (left facing) sod shock, SUPERBEE flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../WAF-2D-SUPERBEE-riemann-sod-shock-reverse-2D.png}%
        \caption{WAF method for (left facing) sod shock, SUPERBEE flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../WAF-kelvin-helmholtz-0001.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-NO_LIMITER-riemann-sod-shock-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-NO_LIMITER-riemann-sod-shock-reverse-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-MINMOD-riemann-sod-shock-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-MINMOD-riemann-sod-shock-reverse-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-VANLEER-riemann-sod-shock-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-VANLEER-riemann-sod-shock-reverse-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-SUPERBEE-riemann-sod-shock-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-1D-SUPERBEE-riemann-sod-shock-reverse-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (right facing) sod shock, MINMOD flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-MINMOD-riemann-sod-shock-2D.png}%
        \caption{MUSCL method for (right facing) sod shock, MINMOD flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (left facing) sod shock, MINMOD flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-MINMOD-riemann-sod-shock-reverse-2D.png}%
        \caption{MUSCL method for (left facing) sod shock, MINMOD flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (right facing) sod shock, van Leer flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-VANLEER-riemann-sod-shock-2D.png}%
        \caption{MUSCL method for (right facing) sod shock, van Leer flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (left facing) sod shock, van Leer flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-VANLEER-riemann-sod-shock-reverse-2D.png}%
        \caption{MUSCL method for (left facing) sod shock, van Leer flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (right facing) sod shock, SUPERBEE flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-SUPERBEE-riemann-sod-shock-2D.png}%
        \caption{MUSCL method for (right facing) sod shock, SUPERBEE flux limiter. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{MUSCL method for (left facing) sod shock, SUPERBEE flux limiter. Expected result.}
        \includegraphics[width=.9\textwidth]{../MUSCL-2D-SUPERBEE-riemann-sod-shock-reverse-2D.png}%
        \caption{MUSCL method for (left facing) sod shock, SUPERBEE flux limiter. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../MUSCL-kelvin-helmholtz-0001.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-CONSTANT-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-GODUNOV-CONSTANT-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-GODUNOV-CONSTANT-RK4-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-WAF-CONSTANT-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-WAF-CONSTANT-RK4-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-MUSCL-CONSTANT-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-MUSCL-CONSTANT-RK4-2D-0001.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-RADIAL-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-GODUNOV-RADIAL-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-GODUNOV-RADIAL-RK4-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-WAF-RADIAL-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-WAF-RADIAL-RK4-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-MUSCL-RADIAL-RK2-2D-0001.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../SOURCES-MUSCL-RADIAL-RK4-2D-0001.png}%
