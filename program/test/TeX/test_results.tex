...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock-1D.png}%
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock-reverse-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-left-vacuum-1D.png}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for left vacuum state. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-right-vacuum-1D.png}
        \caption{Godunov's method for left vacuum state. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-vacuum-generating-1D.png}%
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for (right facing) sod shock. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock-2D.png}%
        \caption{Godunov's method for (right facing) sod shock. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for (left facing) sod shock. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-sod-shock-reverse-2D.png}%
        \caption{Godunov's method for (left facing) sod shock. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for left vacuum state. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-left-vacuum-2D.png}
        \caption{Godunov's method for left vacuum state. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for left vacuum state. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-right-vacuum-2D.png}
        \caption{Godunov's method for left vacuum state. Obtained result.}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Godunov's method for vacuum generating conditions. Expected result.}
        \includegraphics[width=.9\textwidth]{../GODUNOV-riemann-vacuum-generating-2D.png}%
        \caption{Godunov's method for vacuum generating conditions. Obtained result.}
    \end{figure}
...
%--------------------------------------------------------
    ...
    \begin{figure}[htbp]
        ...
        \includegraphics[width=.9\textwidth]{../kelvin-helmholtz-0001.png}%
