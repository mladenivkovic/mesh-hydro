...
typedef struct {
  ...
  MYFLOAT tmax;                           /* at what time to end */

  MYFLOAT ccfl;                           /* CFL coefficient */
  int nx;                               /* number of mesh points */
  int nxtot;                            /* number of mesh points, including boundary cells */
  MYFLOAT dx;                             /* cell size */
  MYFLOAT force_dt;                       /* force a time step size (except if you need to write an output) */
  ...
  MYFLOAT dt_out;                         /* time interval between outputs */
  ...
  MYFLOAT *outputtimes;                   /* array of output times given in the output file */
