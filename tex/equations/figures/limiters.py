...
ax.set_ylim(-0.2, 2.2)
ax.add_patch(
    patches.Polygon([(0, 0), (1, 1), (0.5, 1)], fill=True, facecolor="darkgrey")
)
ax.add_patch(
    patches.Polygon([(1, 1), (6, 1), (6, 2), (2, 2)], fill=True, facecolor="darkgrey")
)
...
for name, phi in zip(
    ["minmod", "superbee", "mc", "van Leer"], [minmod, superbee, MC, vanleer]
):
    y = [phi(x) for x in r]
