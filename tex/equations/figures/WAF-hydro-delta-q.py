...
# x label
plt.text(21, 0.0, r"$x$", verticalalignment="center", horizontalalignment="left")
# t label
plt.text(0, 12, r"t", verticalalignment="center", horizontalalignment="center")
...
ax.add_patch(
    patches.Rectangle(
        (xmin, ymin), width=dx, height=height, fill=True, facecolor="thistle"
    )
)
# U_i coloring
ax.add_patch(
    patches.Rectangle(
        (xmin / 2, ymin), width=dx, height=height, fill=True, facecolor="lightblue"
    )
)
# U_i+1 coloring
ax.add_patch(
...
ax.add_patch(
    patches.Rectangle(
        (dx, ymin), width=dx, height=height, fill=True, facecolor="lightblue"
    )
)
