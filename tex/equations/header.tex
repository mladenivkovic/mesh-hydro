...
% Allow line breaks in text
% NOTE: underscores need exception handling. You can't use subscripts in math mode in texttt{} with this.
% NOTE 2: only *pure* underscores will allow breaks, escaped ones dont. Example:
% \texttt{this_will_break} and \texttt{this\_wont\_break}
