...
from hydro_io import read_output, read_ic
...
if __name__ == "__main__":
    ...
    for limiter in limiters:
        filelist.append("./advection-1D-four-shapes-ADVECTION_PWLIN-"+limiter+"-1D-0001.out")
    ...
    for i, f in enumerate(filelist):
        ...
        if ndim != 1:
            ...
            fig = plot_1D_density_only(rho, t=t, label=limiter_names[i], dashed=False, fig = fig )


    # plot ICs
    ndim, twostate, rho, u, p = read_ic('./advection-1D-four-shapes.dat')
    fig = plot_1D_density_only(rho, t=t, label='analytical solution', dashed=True, fig=fig)
